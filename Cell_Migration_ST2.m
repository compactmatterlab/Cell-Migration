...
xPnts = 3;%.............................Number of parameter data points
...
Tsearch = (linspace(pr(3,1),pr(3,2),yPnts));%..........Search time range
FiberAI = (linspace(pr(4,1),pr(4,2),xPnts));%......Fiber Alignment range
rgdPeptides = [5.2,6,8];% (linspace(pr(5,1),pr(5,2),yPnts));%.....RGD Peptides range
...
parfor xd=1:xPnts
    ...
    p = [3.7,.001,1/16,0,rgdPeptides(xd)];
    ...
    for yd=1:yPnts
        ...
        for i=dt:dt:runTime
            ...
            if bonds < Bmin || (bonds < Bmax && t > searchTime)
                ...
                pseudoVect = zeros(1,3);%......000Reset pseudopod direction
...
%=========================================================================%        
        ...
        try%....................Curve fit to get slope for average velocity
            ...
            c = coeffvalues(f);
            avgVel(xd,yd,samp) = c(1);%............................Cell Speed
            R1(xd,yd,samp) = g.rsquare;%......................Goodness of fit
        catch
        ...
        try%.........Curve fit to get random motility coefficient and alpha
            ...
            c = coeffvalues(f);
            D(xd,yd,samp) = c(1);%................Random motility coefficient 
            alp(xd,yd,samp) = c(2);%....................................Alpha
            R2(xd,yd,samp) = g.rsquare;%......................Goodness of fit
        catch
...
%         end
        ...
        try%............................Curve fit to get persistence length
            ...
            c = coeffvalues(f);
            LpR(xd,yd,samp) = c(1);%.......................Persistence length
            R3(xd,yd,samp) = g.rsquare;%......................Goodness of fit
        catch
            LpR(xd,yd,samp) = 0;
            R3(xd,yd,samp) = 0;
        end
