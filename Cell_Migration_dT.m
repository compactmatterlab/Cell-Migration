...
samples = 20;%..................................Sample size to get averages
dataPnts = 10;%.............................Number of parameter data points
...
parfor par=1:dataPnts
    ...
    dlt = [0.5,1,2,4,8,15,30,60,120,240];
    dt = dlt(par);
    time = ((0:1+runTime/dt-1)');%...................Time at each cell position
    tMax = (floor((1+runTime/dt)/8));%.............Maximum time for MSD fitting
    tMsd = dt*((1:tMax)')/3600;%.....................Time steps for MSD fitting

    p = [3.7,0.001,1/16,0,6]; 
