...
samples = 2;%..................................Sample size to get averages
dataPnts = 3000;%.............................Number of parameter data points
...
pr = [0.0005 0.002;%............................Fiber density (fibers/um^3)
    0.15 0.25;%.......................................Fiber Diameter (um)
    0 0.8];%...........................................Fiber alignment (AI)
    

%Variables to be analyzed
rng(211)
pvars = zeros(dataPnts,3);
for i=1:dataPnts
    for j=1:3
        pvars(i,j) = (pr(j,1)+(pr(j,2)-pr(j,1))*rand);
    end
end
...
parfor par=1:dataPnts
    ...
    fiberDens = p(1);%.......................................Fiber density
    Fiber_D = p(2);
    dL = (RGD*.7*.9)/((Ltropo+0.067)*Dtropo);%.............RGD ligand density
    
    avgSearchTime = 1/(1/16);%.......................Pseudopod extension time
    
    AI = p(3);%.............................................Fiber Alignment
